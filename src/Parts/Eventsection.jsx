...
<div className="mt-10 p-5 mb-10 rounded-xl md:flex gap-5 mx-auto justify-center h-[70%] items-center w-[80vw]">
  ...
  <Link to="/Hackathon" className='mb-14 md:mb-0'>
    <div className="cards p-5 mt-7 md:mt-0 shadow-xl bg-[#eeeee4] rounded-xl w-[300px] flex flex-col justify-center items-center mx-auto mb-10 md:mb-0">
      <div>
