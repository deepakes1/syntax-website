    ...
    <div className=' bg-navbar w-[90vw]  mx-auto text-white p-2 md:p-6 '>
      <div className="md:flex justify-between items-center text-lg font-semibold">
        <div className="flex items-center  justify-between">
          <img src={Logo}  className='h-20 w-20 object-contain rounded-full' alt="" />
        ...
        <div className={`hidden  mt-4 md:mt-0 text-center md:flex second-color font-bold md:font-semibold md:text-md gap-3`}>
          ...
          <div className='mb-1'><Link to = "/About" className='md:bg-[#40377D] md:px-6 md:py-2 rounded-tl-3xl rounded-br-3xl md:text-[#E6E6FA]'>About</Link></div>
          <div className='mb-1'><Link to='/contact' className='md:bg-[#40377D] md:px-6 md:py-2 rounded-tl-3xl rounded-br-3xl md:text-[#E6E6FA]'>Contact</Link></div>
           <div className='mb-1'><Link to='/Schedule' className='md:bg-[#40377D] md:px-6 md:py-2 rounded-tl-3xl rounded-br-3xl md:text-[#E6E6FA]'>Schedule</Link></div>
        </div>
      </div>
    </div>
  );
